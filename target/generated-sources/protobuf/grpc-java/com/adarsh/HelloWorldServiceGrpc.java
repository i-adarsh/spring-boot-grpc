...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.adarsh.HelloWorldRequest,
      com.adarsh.HelloWorldResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.adarsh.HelloWorldRequest.class,
      responseType = com.adarsh.HelloWorldResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.adarsh.HelloWorldRequest,
      com.adarsh.HelloWorldResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.adarsh.HelloWorldRequest, com.adarsh.HelloWorldResponse> getHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getHelloMethod = HelloWorldServiceGrpc.getHelloMethod) == null) {
          HelloWorldServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.adarsh.HelloWorldRequest, com.adarsh.HelloWorldResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.adarsh.HelloWorldRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.adarsh.HelloWorldResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(com.adarsh.HelloWorldRequest request,
        io.grpc.stub.StreamObserver<com.adarsh.HelloWorldResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceStub
    ...
    /**
     */
    public void hello(com.adarsh.HelloWorldRequest request,
        io.grpc.stub.StreamObserver<com.adarsh.HelloWorldResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceBlockingStub
    ...
    /**
     */
    public com.adarsh.HelloWorldResponse hello(com.adarsh.HelloWorldRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.adarsh.HelloWorldResponse> hello(
        com.adarsh.HelloWorldRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.adarsh.HelloWorldRequest) request,
              (io.grpc.stub.StreamObserver<com.adarsh.HelloWorldResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.adarsh.HelloWorldRequest,
              com.adarsh.HelloWorldResponse>(
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.adarsh.Hello.getDescriptor();
    }
